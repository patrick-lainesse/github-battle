...
/*defining what type should the props be*/
LanguagesNav.propTypes = {
    selected: PropTypes.string.isRequired,
    onUpdateLanguage: PropTypes.func.isRequired
}

// Display the fetched repositories in a grid
function ReposGrid({repos}) {
    return (
        // Loop over each repo of the array and display in a card
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                {/*Display fetched repos in a grid*/}
